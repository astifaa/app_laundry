      ...
      <div class="col-12">
        <div class="card card-danger">
          <div class="card-header">
            <h3 class="card-title">Data Transaksi Proses</h3>
            ...
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                $data = mysqli_query($kon,"
                  ...
                  WHERE
                  tb_transaksi.status = 'proses' ORDER BY tb_transaksi.id_transaksi desc
                  ");
                ...
                while($d = mysqli_fetch_array($data)){
                  ...
                  <tr>
                    ...
                    <td><a class="btn btn-success btn-sm" href='proses_aksi.php?id_transaksi=<?php echo $d['id_transaksi']?>&act=selesai'>Selesai</a>
                    </td>
                  </tr>
                <?php } ?>
              </tbody>
