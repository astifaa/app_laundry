	...
	<div id="wrapper">
		...
		<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
			...
			<a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
				...
				<marquee>
					<div class="sidebar-brand-text mx-3">Halo Kasir<sup></sup> A'team Laundry</div>
				</marquee>
			</a>
			...
			<li class="nav-item active">
				...
				<li class="nav-item">
					...
					<li class="nav-item">
						...
						<li class="nav-item">
							<a class="nav-link" href="?page=laporanPendapatan">
								<i class="fas fa-fw fa-tachometer-alt"></i>
						...
						<div id="content-wrapper" class="d-flex flex-column">
							...
							<div id="content">
								...
								<nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
									...
									<marquee>
										<form>
											Selamat Datang Kasir A'team Laundry
										</form>
									</marquee>
				...
				<div class="container-fluid">
					...
					switch($page){
						...
						include "kasir/laporanPendapatan.php";
						break;
						case 'dataMember':
						include "kasir/dataMember.php";
						break;
						case 'transaksi':
